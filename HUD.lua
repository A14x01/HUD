...
local function Firsthud()
    ...
    draw.RoundedBox(3, x, y, 200, 90, Color(155, 155, 155, 155) )
    if hp<100 then
        draw.RoundedBox(2, x + 10 , y + 10, math.Clamp(hp, 0, maxhp)*1.9, 30, Color(255, 0, 0, 205)   )
    else
    ...
    if arm<100 then
        draw.RoundedBox(2, x + 10 , y + 50, math.Clamp(arm, 0, 180)*1.8, 30, Color(255, 0, 0, 205)   )
    else
    ...
    draw.SimpleText('HP: ' .. hp .. '/' .. maxhp, 'firstfont', x+25, y+15, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
    draw.SimpleText('AR: ' .. arm, 'firstfont', x+25, y+50, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
